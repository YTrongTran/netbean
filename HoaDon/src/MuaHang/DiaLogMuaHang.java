 ...
 */
public class DiaLogMuaHang extends javax.swing.JDialog {
public static List<SanPham> lssp = new ArrayList<>();
    SanPhamDAO dao = new SanPhamDAO();

    /**
     * Creates new form DiaLogMuaHang
     */
    public DiaLogMuaHang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void btnmuahangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnmuahangActionPerformed
        ...
        SanPham sp = dao.getSanPhamBYID(Integer.parseInt(txtmahang.getText()));
        if (sp != null) {
            sp.setSoLuong(Integer.parseInt(txtsoluong.getText()));
           JfMuaHang.lssp.add(sp);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DiaLogMuaHang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DiaLogMuaHang dialog = new DiaLogMuaHang(new javax.swing.JFrame(), true);
