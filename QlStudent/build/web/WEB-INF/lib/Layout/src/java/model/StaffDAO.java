...
public class StaffDAO {
    public List<Staff> getall(){
        ...
        Statement sttm = null;
        try {
            String sSQl="select * from Staffs inner join Departs on Staffs.depart_id = Departs.id";
    ...
    public int insert(Staff u){
        ...
        PreparedStatement sttm = null;
        try {
            String sSQL = "insert into Staffs (id, name, email, gender,birthday,photo,phone,salary,depart_id) values (?,?,?,?,?,?,?,?,?);";
            conn = DatabaseUtils.getDBCOnnect();
            sttm = conn.prepareStatement(sSQL);
    ...
    public int update(Staff u){
        ...
        PreparedStatement sttm = null;
        try {
            String sSQL = "update Staffs set name=?,email=?,gender=?,birthday=?,photo=?,phone=?,salary=?,depart_id=? where id =?";
            conn = DatabaseUtils.getDBCOnnect();
            sttm = conn.prepareStatement(sSQL);
