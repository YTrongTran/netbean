...
//            }else{
            ...
            String name=request.getParameter("NAME");
             ...
             String email=request.getParameter("EMAIL");
              ...
              Student st=new Student(Integer.parseInt(id),name,phone,email,dd.parse(ngaysinh));
              
              if( StudentDAO.t>=0){
                try {
                    dao.edit( StudentDAO.t, st);
              ...
              StudentDAO.v=-1;
            try {
                request.setAttribute("LIST-STUDENT", dao.getALL());
            } catch (SQLException ex) {
                Logger.getLogger(ListStudentServlet.class.getName()).log(Level.SEVERE, null, ex);
            }
