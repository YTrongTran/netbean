<%-- 
    ...
    Created on : Feb 17, 2020, 11:24:17 AM
    Author     : Tran Y
--%>
<%@page import="DateHelps.DateHelper"%>
                    ...
                    <form action="UserServlet">
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio"><!--value = 1 => Nam| 0 =>Nu -->
                                <label class="checkbox-inline"><input type="radio" name="gender" <%if (u.isGender()) {out.print("checked");}%> value="1" checked >Male</label>
                                <label class="checkbox-inline"><input type="radio" name="gender" <%if(!u.isGender()) {out.print("checked");}%> value="0"> Female</label>
