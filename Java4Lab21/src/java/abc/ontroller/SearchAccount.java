 ...
 */
package abc.ontroller;

import abc.Util.CustomerDB;
...
public class SearchAccount extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<td>");
            out.println("Ten Thue Bao");
            out.println("</td>");

            out.println("<td>");
            out.println("So Dien Thoai");
            out.println("</td>");
            ...
            out.println("</tr>");
            List<Customer> ls = CustomerDB.getAll();
            for (int i = 0; i < ls.size(); i++) {
                ...
                out.println("<td>");
                out.println(c.getTenThueBao());
                out.println("</td>");

                out.println("<td>");
                out.println(c.getSoDT());
                out.println("</td>");

                out.println("<td>");
                out.println(c.getDiaChi());
                out.println("</td>");
                out.println("</tr>");
